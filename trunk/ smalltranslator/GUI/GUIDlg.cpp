...
/////////////////
	...
	popupPoster=NULL;
	HWND hWind = AfxGetApp()->m_pMainWnd->GetSafeHwnd(); //得到当前窗口的句柄
	InstallLaunchEv(hWind); //安装钩子，install hook ,and transfer the main dialog's handle;
